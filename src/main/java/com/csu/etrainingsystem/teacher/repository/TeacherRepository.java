...
public interface TeacherRepository extends JpaRepository<Teacher,String> {
     ...
     * @return 查询所得的教师列表
     */
    @Query(value = "select * from teacher  where t_group_id like ?1 and role like ?2 and material_privilege like ?3 and overtime_privilege like ?4 and teacher.del_status=0",nativeQuery = true)
